                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            <input
                                ...
                                name="remember-me"
                                type="checkbox"
                                className="h-4 w-4 text-gray-300 focus:ring-gray-300 border-gray-600 rounded bg-gray-800"
                            />
                        ...
                        <div className="text-sm">
                            <Link href="/forgot-password" className="font-medium text-gray-200 hover:text-white transition-colors">
                    ...
                    <div className="text-center">
                        <p className="text-sm text-gray-300">
                            ...
                            <Link href="/register" className="font-medium text-gray-100 hover:text-white transition-colors">
                                Sign up
                            </Link>
                        </p>
                    </div>
